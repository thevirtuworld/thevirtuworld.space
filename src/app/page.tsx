    ...
    <div className="max-w-7xl mx-auto px-6 py-4">
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-4 items-center">
          ...
          <button className="px-4 py-2 bg-primary text-background rounded-full hover:bg-primary/80 transition-colors">
            Launch App
          </button>
        </div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
        <div className="lg:w-1/2">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <button className="px-8 py-4 border border-primary/30 backdrop-blur-sm rounded-full text-lg font-semibold hover:border-primary transition-all">
              Join Metaverse
            </button>
          </div>
    ...
    <div className="max-w-7xl mx-auto px-6 relative z-10">
      <div className="flex flex-col lg:flex-row items-center gap-12">
        <div className="lg:w-1/2">
          ...
          <button className="mt-8 px-6 py-3 bg-primary text-background rounded-full hover:bg-primary/80 transition-colors">
            Explore Metaverse
          </button>
        </div>
